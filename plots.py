...
# fig.add_trace(go.Scatter(x=[1,2,3,4],y = [72.1,75.4,77.6,79.9],mode="lines+markers",name="FreeMatch"))
# fig.add_trace(go.Scatter(x=[1,2,3,4],y = [69.1,72.3,76.7,77.6],mode="lines+markers",name="FixMatch+CR"))
...
# fig.add_trace(go.Scatter(x=[1,2,3,4],y = [67.1,72.8,76.7,78.8],mode="lines+markers",name="LabelProp"))
